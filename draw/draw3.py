...
interval = 20
book = open_workbook('../results/result_v8.9.xls')
book2 = open_workbook('../results/result_v8.9_2.xls')
book3 = open_workbook('../results/result_v8.10_2.xls')
book4 = open_workbook('../results/result_v8.11.xls')
