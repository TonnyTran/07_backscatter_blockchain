...
interval = 20
book = open_workbook('../results/result_v4.0_03.xls')
book2 = open_workbook('../results/result_v2.0_3.xls')
book3 = open_workbook('../results/result_v4.0_05.xls')
book4 = open_workbook('../results/result_v3.0.xls')
