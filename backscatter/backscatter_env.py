...
class BackscatterEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.nb_actions = (BackscatterEnv.BUSY_TIMESLOT+1) ** 2 * (BackscatterEnv.TIME_FRAME - BackscatterEnv.BUSY_TIMESLOT+1)

        self.action_space = ActionSpace((Discrete(BackscatterEnv.BUSY_TIMESLOT+1),
                                         Discrete(BackscatterEnv.BUSY_TIMESLOT+1),
                                         Discrete(BackscatterEnv.TIME_FRAME - BackscatterEnv.BUSY_TIMESLOT+1)))
    ...
    def step(self, action):
        ...
        backscatter_time_2 = BackscatterEnv.BUSY_TIMESLOT - harvest - backscatter_time_1
        transmit_time_2 = BackscatterEnv.TIME_FRAME - BackscatterEnv.BUSY_TIMESLOT - transmit_time_1
        reward = 0
        if((backscatter_time_2 >= 0) and (transmit_time_2 >= 0)):
            harvest_time_1 = BackscatterEnv.BUSY_TIMESLOT - backscatter_time_1
            harvest_time_2 = BackscatterEnv.BUSY_TIMESLOT - backscatter_time_2
